...
// Sample data for the contract - matching the Blade template structure
$contractData = [
    ...
    'order' => (object)[
        'note' => 'Contract generated for unit A-1501 at Sunset Towers',
...
try {
    ...
    // Generate filename
    $filename = 'contract_' . $contractData['order']->contract_number . '_' . date('Y-m-d_H-i-s') . '.pdf';
    ...
    // Also save to storage using Laravel's Storage facade
    Storage::disk('public')->put('contracts/' . $filename, $pdf->output());

    echo "✅ Contract PDF generated successfully!\n";
    echo "📄 File: $filename\n";
